...
keytool -importkeystore -destkeystore "./Minion2.evaluation.tpaas.emulab.net.jks" -srckeystore "./Minion2.evaluation.tpaas.emulab.net.p12" -srcstorepass "Passss" -srcstoretype "pkcs12" -alias "Minion2.evaluation.tpaas.emulab.net" -storepass "Passss" -noprompt
