...
keytool -importkeystore -destkeystore "./Minion3.evaluation.tpaas.emulab.net.jks" -srckeystore "./Minion3.evaluation.tpaas.emulab.net.p12" -srcstorepass "Passss" -srcstoretype "pkcs12" -alias "Minion3.evaluation.tpaas.emulab.net" -storepass "Passss" -noprompt
