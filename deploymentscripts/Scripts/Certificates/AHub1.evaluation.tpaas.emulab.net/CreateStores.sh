...
keytool -importkeystore -destkeystore "./AHub1.evaluation.tpaas.emulab.net.jks" -srckeystore "./AHub1.evaluation.tpaas.emulab.net.p12" -srcstorepass "Passss" -srcstoretype "pkcs12" -alias "AHub1.evaluation.tpaas.emulab.net" -storepass "Passss" -noprompt
