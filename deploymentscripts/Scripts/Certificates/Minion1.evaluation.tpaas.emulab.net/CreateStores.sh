...
keytool -importkeystore -destkeystore "./Minion1.evaluation.tpaas.emulab.net.jks" -srckeystore "./Minion1.evaluation.tpaas.emulab.net.p12" -srcstorepass "Passss" -srcstoretype "pkcs12" -alias "Minion1.evaluation.tpaas.emulab.net" -storepass "Passss" -noprompt
